...
export const RejectButton: React.FC<applyReplyButtonProps> = ({ onClick }) => {
  return (
    <Button
      onClick={onClick}
      className="flex h-[3.2rem] w-[6.9rem] gap-[0.8rem] rounded-[0.6rem] border-[0.1rem] border-primary bg-white px-[1.2rem] py-[0.8rem]"
    >
...
export const ApproveButton: React.FC<applyReplyButtonProps> = ({ onClick }) => {
  return (
    <Button
      onClick={onClick}
      className="flex h-[3.2rem] w-[6.9rem] gap-[0.8rem] rounded-[0.6rem] border-[0.1rem] border-blue-20 bg-white px-[1.2rem] py-[0.8rem]"
    >
